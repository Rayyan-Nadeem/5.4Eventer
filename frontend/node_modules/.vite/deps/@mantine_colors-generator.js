...
Color_default.prototype.luminance = function(lum, mode = "rgb") {
  if (lum !== void 0 && type_default(lum) === "number") {
    ...
    const rgb3 = (cur_lum > lum ? test(new Color_default([0, 0, 0]), this) : test(this, new Color_default([255, 255, 255]))).rgb();
...
var hcl2rgb = (...args) => {
  const hcl2 = unpack_default(args, "hcl").reverse();
...
var { min: min2, sqrt: sqrt3, acos } = Math;
var rgb2hsi = (...args) => {
...
function limits(data, mode = "equal", num3 = 7) {
  ...
  if (mode.substr(0, 1) === "e") {
    ...
    for (let i = 1; i < num3; i++) {
      limits2.push(min5 + i / num3 * (max5 - min5));
    }
    limits2.push(max5);
    ...
    const min_log = Math.LOG10E * log(min5);
    const max_log = Math.LOG10E * log(max5);
    limits2.push(min5);
    for (let i = 1; i < num3; i++) {
    ...
    centroids.push(min5);
    for (let i = 1; i < num3; i++) {
      centroids.push(min5 + i / num3 * (max5 - min5));
    }
    centroids.push(max5);
    while (repeat) {
...
var { sqrt: sqrt5, pow: pow7, min: min4, max: max3, atan2: atan23, abs: abs2, cos: cos5, sin: sin4, exp, PI: PI3 } = Math;
...
var oklch2css_default = oklab2css2;
...
var RE_RGBA_LEGACY = /^rgba\(\s*(-?\d+),\s*(-?\d+)\s*,\s*(-?\d+)\s*,\s*([01]|[01]?\.\d+)\)$/;
var RE_RGB_PCT = /^rgb\(\s*(-?\d+(?:\.\d+)?)% \s*(-?\d+(?:\.\d+)?)%\s* \s*(-?\d+(?:\.\d+)?)%\s*\)$/;
var RE_RGB_PCT_LEGACY = /^rgb\(\s*(-?\d+(?:\.\d+)?)%,\s*(-?\d+(?:\.\d+)?)%\s*,\s*(-?\d+(?:\.\d+)?)%\s*\)$/;
var RE_RGBA_PCT = /^rgba?\(\s*(-?\d+(?:\.\d+)?)% \s*(-?\d+(?:\.\d+)?)%\s* \s*(-?\d+(?:\.\d+)?)%\s*\/\s*([01]|[01]?\.\d+)\)$/;
var RE_RGBA_PCT_LEGACY = /^rgba\(\s*(-?\d+(?:\.\d+)?)%,\s*(-?\d+(?:\.\d+)?)%\s*,\s*(-?\d+(?:\.\d+)?)%\s*,\s*([01]|[01]?\.\d+)\)$/;
var RE_HSL = /^hsl\(\s*(-?\d+(?:\.\d+)?)deg \s*(-?\d+(?:\.\d+)?)%\s* \s*(-?\d+(?:\.\d+)?)%\s*\)$/;
var RE_HSL_LEGACY = /^hsl\(\s*(-?\d+(?:\.\d+)?),\s*(-?\d+(?:\.\d+)?)%\s*,\s*(-?\d+(?:\.\d+)?)%\s*\)$/;
var RE_HSLA = /^hsla?\(\s*(-?\d+(?:\.\d+)?)deg \s*(-?\d+(?:\.\d+)?)%\s* \s*(-?\d+(?:\.\d+)?)%\s*\/\s*([01]|[01]?\.\d+)\)$/;
var RE_HSLA_LEGACY = /^hsla\(\s*(-?\d+(?:\.\d+)?),\s*(-?\d+(?:\.\d+)?)%\s*,\s*(-?\d+(?:\.\d+)?)%\s*,\s*([01]|[01]?\.\d+)\)$/;
var RE_LAB = /^lab\(\s*(-?\d+(?:\.\d+)?%?) \s*(-?\d+(?:\.\d+)?%?) \s*(-?\d+(?:\.\d+)?%?)\s*(?:\/\s*(\d+(?:\.\d+)?))?\)?$/;
var RE_LCH = /^lch\(\s*(-?\d+(?:\.\d+)?%?) \s*((?:-?\d+(?:\.\d+)?%?)|none) \s*(-?\d+(?:\.\d+)?(?:deg)?|none)\s*(?:\/\s*(\d+(?:\.\d+)?))?\)?$/;
var RE_OKLAB = /^oklab\(\s*(-?\d+(?:\.\d+)?%?) \s*(-?\d+(?:\.\d+)?%?) \s*(-?\d+(?:\.\d+)?%?)\s*(?:\/\s*(\d+(?:\.\d+)?))?\)?$/;
var RE_OKLCH = /^oklch\(\s*(-?\d+(?:\.\d+)?%?) \s*(?:(-?\d+(?:\.\d+)?%?)|none) \s*(-?\d+(?:\.\d+)?(?:deg)?|none)\s*(?:\/\s*(\d+(?:\.\d+)?))?\)?$/;
var { round: round5 } = Math;
var roundRGB = (rgb3) => {
  return rgb3.map((v, i) => i <= 2 ? limit_default(round5(v), 0, 255) : v);
};
var percentToAbsolute = (pct, min5 = 0, max5 = 100, signed = false) => {
  if (typeof pct === "string" && pct.endsWith("%")) {
    pct = parseFloat(pct.substring(0, pct.length - 1)) / 100;
    if (signed) {
      pct = min5 + (pct + 1) * 0.5 * (max5 - min5);
    } else {
      pct = min5 + pct * (max5 - min5);
    }
  }
  return +pct;
};
...
var css2rgb = (css2) => {
  ...
  if ((m = css2.match(RE_RGBA)) || (m = css2.match(RE_RGBA_LEGACY))) {
  ...
  if ((m = css2.match(RE_RGB_PCT)) || (m = css2.match(RE_RGB_PCT_LEGACY))) {
    const rgb3 = m.slice(1, 4);
    for (let i = 0; i < 3; i++) {
      rgb3[i] = round5(rgb3[i] * 2.55);
    }
    rgb3[3] = 1;
    return rgb3;
  }
  if ((m = css2.match(RE_RGBA_PCT)) || (m = css2.match(RE_RGBA_PCT_LEGACY))) {
    const rgb3 = m.slice(1, 5);
    for (let i = 0; i < 3; i++) {
      rgb3[i] = round5(rgb3[i] * 2.55);
    }
  ...
  if ((m = css2.match(RE_HSLA)) || (m = css2.match(RE_HSLA_LEGACY))) {
    const hsl3 = m.slice(1, 4);
    hsl3[1] *= 0.01;
    hsl3[2] *= 0.01;
    const rgb3 = hsl2rgb_default(hsl3);
  ...
  if (m = css2.match(RE_LAB)) {
    ...
    lab3[0] = percentToAbsolute(lab3[0], 0, 100);
    lab3[1] = percentToAbsolute(lab3[1], -125, 125, true);
    lab3[2] = percentToAbsolute(lab3[2], -125, 125, true);
    const wp = getLabWhitePoint();
    setLabWhitePoint("d50");
    const rgb3 = roundRGB(lab2rgb_default(lab3));
    setLabWhitePoint(wp);
    rgb3[3] = m[4] !== void 0 ? +m[4] : 1;
    return rgb3;
  }
  ...
  if (m = css2.match(RE_OKLAB)) {
    ...
    oklab3[0] = percentToAbsolute(oklab3[0], 0, 1);
    oklab3[1] = percentToAbsolute(oklab3[1], -0.4, 0.4, true);
    oklab3[2] = percentToAbsolute(oklab3[2], -0.4, 0.4, true);
  ...
  if (m = css2.match(RE_OKLCH)) {
    ...
    oklch3[0] = percentToAbsolute(oklch3[0], 0, 1);
...
css2rgb.test = (s) => {
  return (
    // modern
    RE_RGB.test(s) || RE_RGBA.test(s) || RE_RGB_PCT.test(s) || RE_RGBA_PCT.test(s) || RE_HSL.test(s) || RE_HSLA.test(s) || RE_LAB.test(s) || RE_LCH.test(s) || RE_OKLAB.test(s) || RE_OKLCH.test(s) || // legacy
    RE_RGB_LEGACY.test(s) || RE_RGBA_LEGACY.test(s) || RE_RGB_PCT_LEGACY.test(s) || RE_RGBA_PCT_LEGACY.test(s) || RE_HSL_LEGACY.test(s) || RE_HSLA_LEGACY.test(s)
  );
};
...
// node_modules/@mantine/colors-generator/esm/generate-colors.mjs
...
//# sourceMappingURL=@mantine_colors-generator.js.map
