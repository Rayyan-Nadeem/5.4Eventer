    ...
    return (
        <div className={classes.footer} style={{ marginBottom: '25px !important' }}>
            <Container className={classes.inner} style={{ paddingBottom: '0' }}>
                <img src={eventerLogo} alt="Eventer Logo" style={{ width: 200, height: 50 }} />
            ...
            <div className={classes.footerBottom} style={{ textAlign: 'center', marginBottom: '15px !important' }}>
                <div className={classes.info}>
                    <p style={{ textAlign: 'center', fontSize: '24px', fontWeight: 'bold', color: '#e9910d', marginTop: "0" }}>
                        <a href="mailto:support@mrbeast.com" style={{ color: '#e9910d', textDecoration: 'none' }}>
                            support@mrbeast.com
                        </a>
                    </p>
                ...
                <p style={{ fontSize: '18px', fontWeight: 'bold' }}>
                    <a href="https://mrbeast.store/policies/privacy-policy" style={{ color: '#e9910d', textDecoration: 'none' }}>
                        Privacy Policy
                    </a>
                </p>
                <p style={{ fontSize: '18px', fontWeight: 'bold' }}>
